import { useState, type FC, type HTMLProps, type ReactElement, type ReactNode } from 'react';
...
export const ExpandableMenu: FC<ExpandableSideMenuLayoutProps> = ({
	...
	return (
		<HeaderContentFooterLayout
			className={clsx('border-base-300 z-30 border-r', 'transition-[width]', expanded ? 'w-[200px]' : 'w-[49px]')}
			header={
				<header
			...
			footer={
				...
				>
					<button
						...
						className={'hover:bg-base-300 flex h-12 items-center p-4'}
					>
