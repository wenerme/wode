...
export const Basic: Story = {
	render: () => (
		<DaisyDrawer.Root>
			<DaisyDrawer.Trigger className="btn btn-primary">
				Open Drawer
			</DaisyDrawer.Trigger>
			<DaisyDrawer.Portal>
				<DaisyDrawer.Overlay />
...
export const WithCustomContent: Story = {
	render: () => (
		<DaisyDrawer.Root>
			<DaisyDrawer.Trigger className="btn btn-secondary">
				Open Settings
			</DaisyDrawer.Trigger>
			<DaisyDrawer.Portal>
				<DaisyDrawer.Overlay />
...
export const Navigation: Story = {
	render: () => (
		<DaisyDrawer.Root>
			<DaisyDrawer.Trigger className="btn btn-outline">
				Menu
			</DaisyDrawer.Trigger>
			<DaisyDrawer.Portal>
				<DaisyDrawer.Overlay />
