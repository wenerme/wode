...
import { z } from 'zod';
import { type CreateExpireValueHolderOptions, createExpireValueHolder } from '../ExpiryValue';
...
const ExpiryValueSchema = z.object({ value: z.any(), expiresAt: z.coerce.date() });
