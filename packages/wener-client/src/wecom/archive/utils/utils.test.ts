...
describe('collectSdkFiles', () => {
	...
	test('video & voice', () => {
		...
		expect(files).toMatchObject([
			{ md5: '9db09c7fa627c9e53f17736c786a74d5', duration: 10, index: 0 },
			{ md5: 'd06fc80c01d6fbffcca3b229ba41eac6', size: 15169724, duration: 108 },
		]);
	});
	...
	test('mixed', () => {
		...
		expect(files).toMatchObject([{ md5: '368b6c18c82e6441bfd89b343e9d2429', size: 13177, index: 0 }]);
	});
});
