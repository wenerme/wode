...
export const CreateFormRequestSchema = z.object({
  ...
  fatherid: z.string().optional(),
  /** 收集表信息 */
  form_info: z.object({ form_title: z.string(), form_desc: z.string(), form_header: z.string(), form_question: z.object({ items: z.array(z.object({ question_id: z.string(), title: z.string(), pos: z.string(), status: z.number(), reply_type: z.number(), must_reply: z.boolean(), note: z.string(), placeholder: z.string(), question_extend_setting: z.object({ text_setting: z.object({ validation_type: z.number(), validation_detail: z.number(), char_len: z.string(), number_min: z.string(), number_max: z.string() }), radio_setting: z.object({ add_other_option: z.boolean() }), checkbox_setting: z.object({ add_other_option: z.boolean(), type: z.number(), number: z.string() }), location_setting: z.object({ location_type: z.number(), distance_type: z.number() }), image_setting: z.object({ camera_only: z.boolean().default(false), upload_image_limit: z.object({ count_limit_type: z.number(), count: z.string(), max_size: z.string() }) }), file_setting: z.object({ upload_file_limit: z.object({ count_limit_type: z.number(), count: z.string(), max_size: z.string() }) }), date_setting: z.object({ date_format_type: z.number() }), time_setting: z.object({ time_format_type: z.number() }), duration_setting: z.object({ time_scale: z.number(), date_type: z.number(), day_range: z.string() }), temperature_setting: z.object({ unit_type: z.number() }), department_setting: z.object({ allow_multiple_selection: z.boolean().default(false) }), member_setting: z.object({ allow_multiple_selection: z.boolean().default(false) }) }), option_item: z.array(z.object({ key: z.string(), value: z.string(), status: z.number() })) })) }), form_setting: z.object({ fill_out_auth: z.number(), fill_in_range: z.object({ userids: z.array(z.string()), departmentids: z.string() }), setting_manager_range: z.object({ userids: z.array(z.string()) }), timed_repeat_info: z.object({ enable: z.boolean().default(false), remind_time: z.string(), repeat_type: z.number(), week_flag: z.number(), skip_holiday: z.boolean().default(false), day_of_month: z.string(), fork_finish_type: z.number() }), allow_multi_fill: z.boolean().default(false), timed_finish: z.string(), can_anonymous: z.boolean().default(false), can_notify_submit: z.boolean().default(false) }) }),
});
