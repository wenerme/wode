import { type CreateTencentClsMcpServerOptions, TencentClsMcpServerDef } from '@wener/ai/mcp/tencent-cls';
...
export const TencentClsMcpServerHandlerDef = defineMcpServerHandler<CreateTencentClsMcpServerOptions, TencentClsConfig>(
