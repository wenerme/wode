...
export class RelayPageInfo {
	...
	@Field(() => Boolean, { nullable: true, description: 'When paginating backwards, are there more items?' })
	readonly hasPreviousPage!: boolean;

	@Field(() => Boolean, { nullable: true, description: 'When paginating forwards, are there more items?' })
