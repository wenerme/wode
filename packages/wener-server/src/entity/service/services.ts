...
export type ResolveSearchOptions = { search: string };
...
export type EntityServiceStatic<E extends StandardBaseEntity> = { Entity: EntityClass<E> };
...
export type SetEntityStatusOptions = { status: string; state?: string; comment?: string };

export type SetEntityNotesOptions = { notes: string };
...
export type BindEntityOptions = { entityId: string; entityType?: string; entity?: StandardBaseEntity };
