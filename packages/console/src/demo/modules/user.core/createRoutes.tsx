      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              index: true,
              lazy: lazyRoute(() => import('../../../web/pages/setting/appearance/route')),
              handle: {
                title: '显示设置',
              },
              meta: {
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'about',
              lazy: lazyRoute(() => import('../../../web/pages/setting/about/route')),
              handle: {
                title: '系统信息',
              },
            },
        ...
        },
        {
          ...
          children: [
            {
              path: 'debug',
              lazy: lazyRoute(() => import('../../../web/pages/setting/dev/debug/route')),
              handle: {
                title: '调试设置',
              },
            },
