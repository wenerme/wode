...
const FORWARD_REF_STATICS = { $$typeof: true, render: true, defaultProps: true, displayName: true, propTypes: true };
...
const TYPE_STATICS = { [ForwardRef]: FORWARD_REF_STATICS, [Memo]: MEMO_STATICS };
...
export function hoistNonReactStatics<
	...
	C extends { [key: string | symbol]: true } = {},
