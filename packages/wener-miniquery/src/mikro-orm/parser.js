...
function peg$parse(input, options) {
	...
	var peg$f0 = function (next) {
		return next;
	};
	var peg$f1 = function (next) {
		return next;
	};
	...
	var peg$f15 = function (next) {
		return next || [];
	};
	var peg$f16 = function (next) {
		return next;
	};
	var peg$f17 = function (next) {
		return next;
	};
