...
function peg$parse(input, options) {
	...
	var peg$f1 = function (head, tail) {
		return !tail.length ? head : { type: 'logical', operator: 'or', value: [head].concat(tail) };
	};
	var peg$f2 = function (head, tail) {
		return !tail.length ? head : { type: 'logical', operator: 'and', value: [head].concat(tail) };
	};
	var peg$f3 = function (value) {
		return { type: 'not', value };
	};
	var peg$f4 = function (value) {
		return { type: 'parentheses', value };
	};
