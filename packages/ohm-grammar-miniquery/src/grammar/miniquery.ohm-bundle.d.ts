// AUTOGENERATED FILE
// This file was generated from miniquery.ohm by `ohm generateBundles`.
import type { ActionDict, Grammar, IterationNode, Node, NonterminalNode, Semantics, TerminalNode } from 'ohm-js';

export interface MiniQueryActionDict<T> extends ActionDict<T> {
