...
import {
  ...
  type ListPersonalIncomeTaxReportResponse,
  type InputInvoiceListResponseItem,
  type InvoiceInputDetailResponse,
  type InvoiceInputGeneralQueryResponseItem,
  type _InvoiceInputListResponseItem,
