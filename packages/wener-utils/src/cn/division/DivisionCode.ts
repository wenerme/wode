const DivisionCodeLevels = [
	{ level: 1, code: 'Province', length: 2, label: '省' },
	{ level: 2, code: 'City', length: 4, label: '市' },
	{ level: 3, code: 'County', length: 6, label: '区县' },
	{ level: 4, code: 'Town', length: 9, label: '乡镇' },
	{ level: 5, code: 'Village', length: 12, label: '村' },
] as const;
...
export namespace DivisionCode {
	...
	export type ParsedCode = { province: string; city?: string; county?: string; town?: string; village?: string };
