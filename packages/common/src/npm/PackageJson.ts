...
export type IExports =
	| `./${string}`
	| { '.': IExports; [key: `./${string}`]: IExports }
	| { types?: IExports; import?: IExports; require?: IExports; system?: IExports; default?: IExports };
 ...
 * @see https://github.com/ajaxlab/package-json-type/blob/master/src/index.ts
 */
export interface PackageJson {
	 ...
	 */
	readonly resolutions?: { [dependencyName: string]: string };
	 ...
	 * ```
	 */
	readonly scripts?: IScriptsMap | { [scriptName: string]: string };
 ...
 * @see https://nodejs.org/api/process.html#process_process_arch
 */
export type CPU = 'arm' | 'arm64' | 'ia32' | 'mips' | 'mipsel' | 'ppc' | 'ppc64' | 's390' | 's390x' | 'x32' | 'x64';
 ...
 * @see https://nodejs.org/api/process.html#process_process_platform
 */
export type OS = 'aix' | 'android' | 'darwin' | 'freebsd' | 'linux' | 'openbsd' | 'sunos' | 'win32' | 'cygwin';
