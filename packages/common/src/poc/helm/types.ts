...
export type GlobalFlags = { namespace?: string };

export type ListFlags = GlobalFlags & { allNamespaces?: boolean };
...
export type RepoAddFlags = GlobalFlags & { username?: string; password?: string };
