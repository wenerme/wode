...
export const AsmAddressModes: Record<string, { name: string; code?: AddressMode }> = {
	Register: { name: 'Register', code: AddressMode.Register },
	RegisterDeferred: { name: 'RegisterDeferred', code: AddressMode.RegisterDeferred },
	Immediate: { name: 'Immediate', code: AddressMode.Immediate },
	Direct: { name: 'Direct', code: AddressMode.Direct },
	// Symbol: {
	//   name: 'Symbol',
	// },
	// SymbolDeferred: {
...
export type AssemblyCompileContext = { asm: Assembly; buffer: DataView; offset: number };
...
export const AsmOpCodes: Record<string, AsmOpCodeInfo> = {
	...
	LABEL: { name: 'LABEL', pseudo: true },
	COMMENT: { name: 'COMMENT', pseudo: true },
	BLOCK: {
		name: 'BLOCK',
		pseudo: true,
	...
	IN: { name: 'IN', code: Opcode.IN },
	JMP: { name: 'JMP', code: Opcode.JMP },
	JPC: { name: 'JPC', code: Opcode.JPC },
	LD: { name: 'LD', code: Opcode.LD },
	NOP: { name: 'NOP', code: Opcode.NOP },
	OUT: { name: 'OUT', code: Opcode.OUT },
	POP: { name: 'POP', code: Opcode.POP },
	PUSH: { name: 'PUSH', code: Opcode.PUSH },
	CAL: { name: 'CAL', code: Opcode.CAL },
	RET: { name: 'RET', code: Opcode.RET },
	CMP: { name: 'CMP', code: Opcode.CMP },
	EXIT: { name: 'EXIT', code: Opcode.EXIT },
};
