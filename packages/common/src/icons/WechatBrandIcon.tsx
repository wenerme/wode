...
const SvgWechatBrandIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1025 1024" width="1em" height="1em" ref={ref} {...props}>
    <path
      fill="#51C332"
...
const ForwardRef = forwardRef(SvgWechatBrandIcon);
