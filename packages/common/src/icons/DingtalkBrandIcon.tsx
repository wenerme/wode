...
const SvgDingtalkBrandIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" width="1em" height="1em" ref={ref} {...props}>
    <path
      fill="#3296FA"
...
const ForwardRef = forwardRef(SvgDingtalkBrandIcon);
