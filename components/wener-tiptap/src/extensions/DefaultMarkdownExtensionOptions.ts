...
export const DefaultMarkdownExtensionOptions: ExtensionOptions = {
	...
	Strike: Strike.extend({ renderMarkdown: { open: '~~', close: '~~', mixable: true, expelEnclosingWhitespace: true } }),
	...
	Bold: Bold.extend({ renderMarkdown: { open: '**', close: '**', mixable: true, expelEnclosingWhitespace: true } }),
	Italic: Italic.extend({ renderMarkdown: { open: '_', close: '_', mixable: true, expelEnclosingWhitespace: true } }),
};
