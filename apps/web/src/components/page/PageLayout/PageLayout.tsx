...
export const PageLayout: FC<PropsWithChildren & Partial<NextPageProps>> = async ({
	...
	await loadI18n({ reason: 'PageLayout' });
...
const Socials = [
	{ icon: <WenerAvatarIcon className={'h-6 w-6'} />, title: 'Blog', href: 'https://wener.me' },
	{ icon: <PiXLogoFill className={'h-6 w-6'} />, title: 'Twitter', href: 'https://twitter.com/wenerme' },
	{ icon: <PiGithubLogoFill className={'h-6 w-6'} />, title: 'GitHub', href: 'https://github.com/wenerme/wode' },
];
const Footer = () => {
	return (
