...
defineTags({ icon: <IpfsOutlined />, name: 'ipfs', title: 'IPFS' });

defineTags({ icon: <PiBaby />, name: 'children', title: <Trans id={'tags.children'}>儿童</Trans> });
defineTags({ icon: <FaHtml5 />, name: 'web', title: <Trans id={'tags.web'}>Web技术</Trans> });
...
defineEntry([
	...
	{ href: '/web/Intl.Segmenter', title: 'Intl.Segmenter', description: '', tags: ['spec'] },
	{ href: '/web/html-to-react', title: 'HTML to React', description: '', tags: ['parser', 'transform'] },
	{ href: '/sucrase/transform', title: 'Sucrase Transform', description: '', tags: ['parser', 'transform'] },
	{ href: '/eta/render', title: 'ETA Template render', description: '', tags: ['render'] },
	{ href: '/daisy/theme', title: 'DaisyUI theme', tags: ['design'] },
	{ href: '/cn/id', title: 'China ID explainer', icon: <FaHtml5 />, tags: ['parser', 'china'] },
	{ href: '/id/benchmark', title: 'ID generator benchmark', icon: <FaHtml5 />, tags: ['benchmark', 'id'] },
]);

defineEntry([{ href: '/children/riddle/print', title: 'Children Riddle' }]);
