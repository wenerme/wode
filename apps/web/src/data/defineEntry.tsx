...
type EntryDef = { href: string; title: ReactNode; icon: ReactElement; tags: string[]; metadata: Record<string, any> };
...
export function defineEntry(opts: DefineEntryOptions | DefineEntryOptions[]): EntryDef | EntryDef[] {
	...
	const def: EntryDef = { icon: <PiBrowserLight />, tags: [], metadata: [], ...opts };
...
export function defineTags(opts: MaybeArray<DefineTagOptions>): MaybeArray<TagDef> {
	...
	const def: TagDef = { title: startCase(opts.name), metadata: [], ...opts };
