...
export function resolveRequestLocale({
	...
	if (!languages?.length && accept) {
		requestLocales = new Negotiator({ headers: { 'accept-language': accept } }).languages();
	...
	try {
		...
		// languages=['*']
		console.error(`[${resolveRequestLocale.name}] `, { query, cookie, locales, languages: requestLocales }, String(e));
	}

	return { locale, locales, query, cookie, languages: requestLocales };
}
