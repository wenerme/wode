...
import { renderFilePickerWindow, showDirectoryPicker, showFilePicker, showSaveFilePicker } from '@/file/file-picker';
...
const meta = {
	id: 'console-file-picker-window',
	title: 'File/File Picker Window',
