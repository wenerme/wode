...
import type { AgentCommandExecutor } from '@/agent/agent-coding';
import { AgentPlayground } from '@/agent/agent-playground';

const meta = {
	id: 'agent-work-coding-playground',
...
export const loadStoryJustBashBrowser: JustBashModuleLoader = async () => {
	const loaded: unknown = await import(/* @vite-ignore */ 'https://esm.sh/just-bash@3.1.0/browser?bundle' as string);
