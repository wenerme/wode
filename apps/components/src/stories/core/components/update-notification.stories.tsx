...
const meta = {
	id: 'utilities-update-notification',
	title: 'Core/Components/Update Notification',
	parameters: {
		layout: 'fullscreen',
	},
} satisfies Meta;
...
function StateAndDisplayDemo() {
	...
	return (
		<main className='mx-auto min-h-screen w-full max-w-5xl px-4 py-8 md:px-8'>
			...
			<section className='border-base-300 bg-base-300 grid gap-px border-y sm:grid-cols-2 lg:grid-cols-6'>
...
function StatusValue({ label, value }: { label: string; value: string }) {
	return (
		<div className='bg-base-100 px-4 py-4'>
			...
			<div className='mt-1 font-mono text-sm font-medium break-all'>{value}</div>
		</div>
	);
}
