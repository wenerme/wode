...
type InstanceInfo = { instanceId: string; name: string; component: string; service: string; hostname: string };
...
type RemoteEntity = { id: string; uid: string; tid: string; eid?: string; cid?: string; rid?: string };
