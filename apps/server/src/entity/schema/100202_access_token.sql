...
(
  ...
  client_agent_id    text generated always as ( case when subject_type = 'ClientAgent' then subject_id end ) stored,

  attributes         jsonb       not null default '{}',
  properties         jsonb       not null default '{}',
  extensions         jsonb       not null default '{}',
  unique (tid, eid),
  foreign key (client_agent_id) references client_agent (id) on delete cascade
);
