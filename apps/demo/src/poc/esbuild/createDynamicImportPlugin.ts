...
export interface CreateDynamicImportPluginOptions {
 ...
 */
export function createDynamicImportPlugin(config: CreateDynamicImportPluginOptions): Plugin {
...
async function replaceImports(fileContents: string, resolveDir: string, config: CreateDynamicImportPluginOptions) {
